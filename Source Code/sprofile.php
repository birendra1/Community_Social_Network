...
<div style="float:left" padding-top="35px" padding-left="65px" class="about">
     ...
     <tr><td>DOB:</td><td><?php echo $row['dob']; ?></td></tr>
      ...
      <tr><td>Educational:</td><td><?php echo $row['branch']; ?></td></tr>
       <tr><td>About:</td><td></td></tr>
        <tr><td></td><td><form action="sprofileedit.php"><button type="submit"  name="edit" class="button">EDIT</button></form></td></tr>
    </table>
